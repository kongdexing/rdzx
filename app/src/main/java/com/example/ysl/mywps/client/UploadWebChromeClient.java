...
public abstract class UploadWebChromeClient extends WebChromeClient {
    private WebChromeClient mWrappedClient;

    protected UploadWebChromeClient(WebChromeClient wrapperdClient) {
        mWrappedClient = wrapperdClient;
    }
    ...
    public void openFileChooser(ValueCallback<Uri> uploadFile) {
        ((UploadWebChromeClient) mWrappedClient).openFileChooser(uploadFile);
    }
}
